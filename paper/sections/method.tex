...
%                                                       \-> CP-Graph
%   fusion -> EPH -> (logits = tau * cos) + alpha + (vacuity, aleatoric)
%   logits -> per-sample CE -> CFA-GDRO solver (decision D-08)
%   alpha  -> mean EPH      -> additive calibration regulariser
%   probabilities + fused feature -> CP-Graph consistency loss
%   total loss = mean CE + lambda_rob * CFA-GDRO + lambda_evi * mean EPH +
%                lambda_graph * CP-Graph.
